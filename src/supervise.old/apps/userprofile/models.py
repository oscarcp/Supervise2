...
from supervise.apps.userprofile.countries import CountryField
...
DEFAULT_AVATAR = getattr(settings, 'DEFAULT_AVATAR', os.path.join(settings.STATIC_ROOT, "userprofile", "generic.jpg"))

...
from supervise.apps.userprofile.forms import AvatarForm, AvatarCropForm, \
        EmailValidationForm, ProfileForm, _RegistrationForm, LocationForm, \
        ResendEmailValidationForm, PublicFieldsForm
from supervise.apps.userprofile.models import BaseProfile, DEFAULT_AVATAR_SIZE, \
        MIN_AVATAR_SIZE, SAVE_IMG_PARAMS, DEFAULT_AVATAR
...
from supervise.apps.userprofile.models import EmailValidation, Avatar, \
        UserProfileMediaNotFound, GoogleDataAPINotFound, S3BackendNotFound
...
import urllib
import os
from supervise.apps.userprofile import signals
import copy
...
if hasattr(settings, "AVATAR_QUOTA"):
    from supervise.apps.userprofile.uploadhandler import QuotaUploadHandler
